...
# IMAGENET_PRETRAIN=/home/hoangpn/Ecai/DeFRCN/checkpoints/voc/exp1/defrcn_det_r101_base1/model_final.pth
# train teacher model
...
python3 tools/model_surgery.py --dataset voc --method reset                                \
   --src-path ${TEACHER_PATH}/model_final.pth                    \
   --save-dir ${TEACHER_PATH}
TEACHER_WEIGHT=${TEACHER_PATH}/model_reset_optimizer.pth
exit
# train student model
cfg_MODEL='
MUTE_HEADER True
