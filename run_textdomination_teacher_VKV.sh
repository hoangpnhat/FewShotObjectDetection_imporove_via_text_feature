...
# IMAGENET_PRETRAIN=checkpoints/voc/textDomination_VKV/teacher_base/defrcn_det_r101_base1/model_final.pth
...
cfg_MODEL="
MODEL.ROI_HEADS.NAME TextRes5ROIHeads_textDomination_VKV
